...
from django.contrib.auth.forms import AuthenticationForm, SetPasswordForm, UserCreationForm, UserChangeForm
...
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'email', 'last_name', 'password1', 'password2', 'username')
...
class UpdateUserDataForm(UserChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        super(UpdateUserDataForm, self).__init__(*args, **kwargs)
...
class StoreProductForm(forms.ModelForm):
    class Meta:
        model = StoreProduct
        fields = ['name', 'description', 'price', 'quantity', 'category', 'picture']
